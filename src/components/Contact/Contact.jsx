    ...
    <div className="contact" id="contact" onSubmit={onSubmitHandler}>
      ...
      <form action="" className="contact-form">
        ...
        <div>
          ...
          <input type="text" name="Lname" id="Lname" value={lastName} onChange={secondNameHandler} required />
        </div>
        <div>
          <label htmlFor="email">Enter your Email</label>
          <input type="email" name="email" id="email" value={email} onChange={emailChangeHandler} required />
        </div>
        <div>
          <label htmlFor="message">Enter your message</label> <br />
          <textarea name="" id="" cols="30" rows="10" value={message} onChange={messageChangeHandler} placeholder="Type your message" required></textarea>
        </div>
