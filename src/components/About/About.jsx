  ...
  return (
    <div className="About" id="about">
      <div className="about-container">
        <div className="about-image" data-aos="zoom-out" data-aos-offset="200" data-aos-duration="1000">
          <img src="assets/about-8.jpeg" alt="an freelancer"/>
        </div>
        <div className="about-info" data-aos="zoom-out" data-aos-offset="200" data-aos-duration="1000">
